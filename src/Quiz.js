...
import {
    Container, Box, Typography, Card, CardMedia, IconButton, Drawer, List, ListItem,
    ListItemText, Avatar, Button, Grid2
} from '@mui/material';
    ...
    return (
        <motion.button
            ...
            style={{
                ...
                background: correct ? 'linear-gradient(145deg, #4CAF50, #45a049)' :
                    wrong ? 'linear-gradient(145deg, #f44336, #e31b0c)' :
                        'linear-gradient(145deg, #ffffff, #e6e6e6)',
                // boxShadow: active
                //     ? 'inset 5px 5px 10px #d1d1d1, inset -5px -5px 10px #ffffff'
                //     : '5px 5px 10px #d1d1d1, -5px -5px 10px #ffffff',
                color: correct || wrong ? '#ea0000' : '#2c3e50',
...
const NeumorphicButton = ({ children, onClick,active, disabled, correct, wrong }) => {
    return (
        <motion.button
                ...
                <Box sx={{
                    ...
                    <Box sx={{ flex: 1 }}>
                        <Card sx={{
                            ...
                            <Box sx={{ p: 3, flex: 1, overflowY: 'auto',     background: 'linear-gradient(135deg, #f6f8fb 0%, #e9eef5 100%)'
                            }}>
